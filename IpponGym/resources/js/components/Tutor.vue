        ...
        <div class="wrapper-dismissible">
            <div class="form-agrupation">
                ...
                <b-alert
                    ...
                    variant="warning"
                    v-if="underage != null">
                    {{ underage == true ? 'El socio es menor de edad y es obligatorio rellenar los datos del tutor.' : 'El socio no es menor de edad y los datos del tutor son opcionales, se pueden borrar.' }}
                </b-alert>
