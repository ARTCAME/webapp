<template>
    <section id="doc-utils-documentos">
        <h1 class="subtitle">
        ...
        <p>
            ...
            <br>
            &emsp;- Recibos: Podremos escoger de entre los pagos confirmados que tenga un socio
            <br>
            ...
            <br>
            &emsp;- Cesión de imagen: Es la confirmación de si el socio nos permite o no usar su imagen en medios digitales o analógicos. Si el socio es menor se reflejará en el documento junto con los datos del tutor incluidos en la ficha del socio
            <br>
        </p>
        <p>
            Estos documentos no siempre estarán habilitados y deberemos tener en cuenta ciertas consideraciones:
            <br>
            &emsp;- Si un socio no tiene ningún pago con el estado 'Confirmado' no se podrá generar ningún recibo, no se pueden generar recibos sobre pagos en estado 'Pendiente' o 'Devuelto'
            <br>
