...
WacomGSS.STUConstructor = (function() {
  ...
  function STU(port) {
    ...
    // websocket = new WebSocket("wss://app.ippongymzaragoza.es:" + port.toString() + "/ws");
    websocket = new WebSocket("wss://app.ippongymzaragoza.es:" + port.toString());
...
export default WacomGSS.STU = new WacomGSS.STUConstructor();
